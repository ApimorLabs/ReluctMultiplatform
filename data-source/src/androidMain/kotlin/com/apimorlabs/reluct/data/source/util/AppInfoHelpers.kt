...
object AppInfoHelpers {

    /**
     * Get the app icon for the given package name.
     * If it can't get the app icon it will return an empty ByteArray
     * TODO1: Should be fixed to check if the drawable is not found (like app uninstalled)
     */
    fun getAppIcon(context: Context, packageName: String): Icon {
        ...
        return Icon(icon = appIcon.getBitmap()?.toByteArrayUncompressed() ?: byteArrayOf())
    }

    /**
     * Get the App name for the given package name.
