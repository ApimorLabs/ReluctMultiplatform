...
import com.apimorlabs.reluct.compose.ui.all_set_desc_text
import com.apimorlabs.reluct.compose.ui.all_set_text
    ...
    LazyColumn(
        ...
        stickyHeader {
            ListGroupHeadingHeader(
                text = stringResource(Res.string.all_set_text),
        ...
        item {
            Image(
                ...
                painter = painterResource(Res.drawable.confirmed_phone_hand),
        ...
        item {
            Text(
                text = stringResource(Res.string.all_set_desc_text),
                textAlign = TextAlign.Center,
