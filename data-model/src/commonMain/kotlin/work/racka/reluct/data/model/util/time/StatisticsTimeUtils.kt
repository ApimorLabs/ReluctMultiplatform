...
import work.racka.reluct.data.model.util.time.TimeConstants.DAILY_HOURS
import work.racka.reluct.data.model.util.time.TimeConstants.DAYS_OF_WEEK
import work.racka.reluct.data.model.util.time.TimeConstants.HOURLY_MINUTES_SECONDS
import work.racka.reluct.data.model.util.time.TimeConstants.MINUTE_MILLIS
import work.racka.reluct.data.model.util.time.TimeUtils.plus
